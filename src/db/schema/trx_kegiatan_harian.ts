...
export const trxKegiatanHarian = pgTable('trx_kegiatan_harian', {
  ...
  index('idx_trx_kegiatan_harian_pegawai_id').on(table.pegawai_id),
  index('idx_trx_kegiatan_harian_kelompok_id').on(table.kelompok_nelayan_id),
  index('idx_trx_kegiatan_harian_tanggal').on(table.tanggal),
]);

export type TrxKegiatanHarian = typeof trxKegiatanHarian.$inferSelect;
export type InsertTrxKegiatanHarian = typeof trxKegiatanHarian.$inferInsert;
